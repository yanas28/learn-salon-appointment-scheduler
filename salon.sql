...
INSERT INTO public.appointments VALUES (118, '12am', 33, 4);
...
INSERT INTO public.customers VALUES (118, '99-229949', 'Rakashi');
...
--
-- Name: appointments fk_appoitments_services; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fk_appoitments_services FOREIGN KEY (service_id) REFERENCES public.services(service_id);
